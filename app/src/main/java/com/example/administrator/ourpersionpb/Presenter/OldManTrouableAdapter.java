...
public class OldManTrouableAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        viewHolder.oldman_trouable_remark.setText(IsNull(oldManTrouableBean.getRemark()));
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView oldman_trouable_remark;
        ...
        public MyViewHolder(View itemView) {
            ...
            oldman_trouable_remark = (TextView) itemView.findViewById(R.id.oldman_trouable_remark);
