...
public class FormsAdminFragmentThree extends Fragment {
    View view;
    BarChart barChart;
    Random random;
    //树形图的数据
...
CircleImageView circleImageView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.formsadmin_fragmentthree, container, false);
        circleImageView= (CircleImageView) view.findViewById(R.id.formsadminbackfrgament3_menu);
    ...
    public void onResume() {
        ...
        dataSet = new BarDataSet(entries, "老人脉搏测试报表");
        ...
        //图表描述
        barChart.setDescription("老人最近12天脉搏报表(单位：mmHg)");
    }
