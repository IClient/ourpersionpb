...
public class OldManOutAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        viewHolder.oldman_outitem_days.setText(IsNull(oldManOutBean.getDays()));
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            oldman_outitem_days = (TextView) itemView.findViewById(R.id.oldman_outitem_days);
        }
    }
