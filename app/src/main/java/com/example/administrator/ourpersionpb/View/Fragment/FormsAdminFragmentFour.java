...
public class FormsAdminFragmentFour extends Fragment {
    View view;
    BarChart barChart;
    Random random;
    //树形图的数据
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.formsadmin_fragmentfour, container, false);
        circleImageView = (CircleImageView) view.findViewById(R.id.formsadminbackfrgament4_menu);
    ...
    public void onResume() {
        ...
        dataSet = new BarDataSet(entries, "老人心率测试报表");
        ...
        //图表描述
        barChart.setDescription("老人最近12天心率报表(单位：mmHg)");
    }
