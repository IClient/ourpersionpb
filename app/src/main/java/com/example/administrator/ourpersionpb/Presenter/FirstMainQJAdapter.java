...
import com.example.administrator.ourpersionpb.Model.bean.MeQJWork;
...
public class FirstMainQJAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public int getItemViewType(int position) {
        if (position == meQJWork.getMeQJWork().getDatas().size() && meQJWork.getMeQJWork().getDatas().size() > 2) {
            return 2;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MyViewHolder) {
            ...
            if (datasBean.getApplyStartTime2().equals("9999-12-31T23:59:59.997") && datasBean.getApplyEndTime2().equals("9999-12-31T23:59:59.997")) {
                viewHolder.firstmain_qj_qjtime2.setVisibility(View.GONE);

            } else {
                viewHolder.firstmain_qj_qjtime2.setVisibility(View.VISIBLE);
    ...
    public int getItemCount() {
        return meQJWork.getMeQJWork().getDatas().size() + 1;
    }
