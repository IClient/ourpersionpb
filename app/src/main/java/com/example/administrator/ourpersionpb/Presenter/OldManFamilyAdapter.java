...
public class OldManFamilyAdapter extends RecyclerView.Adapter<OldManFamilyAdapter.MyviewHolder> {
    ...
    public void onBindViewHolder(MyviewHolder holder, final int position) {
        ...
        if (TextUtils.isEmpty(familyBean.getBrithday())) {
            holder.oldman_familtitem_birthday.setText("");
        } else {
            holder.oldman_familtitem_birthday.setText(familyBean.getBrithday());
        }
    }
    ...
    public class MyviewHolder extends RecyclerView.ViewHolder {
        ...
        TextView oldman_familtitem_birthday;
        ...
        public MyviewHolder(View itemView) {
            ...
            oldman_familtitem_birthday = (TextView) itemView.findViewById(R.id.oldman_familtitem_birthday);
