...
public class OldManHealthAdapter extends RecyclerView.Adapter<OldManHealthAdapter.MyviewHolder> {
    ...
    public void onBindViewHolder(MyviewHolder holder, final int position) {
        ...
        //--意见处理
        if (healthBean.getRemark()==null) {
            holder.oldman_healthitem_remark.setText("");
        } else {
            holder.oldman_healthitem_remark.setText(healthBean.getRemark().toString());
        }
    }
    ...
    public class MyviewHolder extends RecyclerView.ViewHolder {
        ...
        TextView oldman_healthitem_remark;
        ...
        public MyviewHolder(View itemView) {
            ...
            oldman_healthitem_remark= (TextView) itemView.findViewById(R.id.oldman_healthitem_remark);
        }
    }
